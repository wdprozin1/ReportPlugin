...
public record CommonPlayerSpawnInfo(Holder<DimensionManager> dimensionType, ResourceKey<World> dimension, long seed, EnumGamemode gameType, @Nullable EnumGamemode previousGameType, boolean isDebug, boolean isFlat, Optional<GlobalPos> lastDeathLocation, int portalCooldown, int seaLevel) {

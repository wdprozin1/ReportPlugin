...
public record ClientboundRecipeBookRemovePacket(List<RecipeDisplayId> recipes) implements Packet<PacketListenerPlayOut> {
    ...
    public void handle(PacketListenerPlayOut packetlistenerplayout) {
        packetlistenerplayout.handleRecipeBookRemove(this);
    }
}

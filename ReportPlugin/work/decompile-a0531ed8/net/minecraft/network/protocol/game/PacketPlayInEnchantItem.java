...
public record PacketPlayInEnchantItem(int containerId, int buttonId) implements Packet<PacketListenerPlayIn> {
    ...
    public static final StreamCodec<PacketDataSerializer, PacketPlayInEnchantItem> STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.CONTAINER_ID, PacketPlayInEnchantItem::containerId, ByteBufCodecs.VAR_INT, PacketPlayInEnchantItem::buttonId, PacketPlayInEnchantItem::new);

...
public class LoginProtocols {
    ...
    public static final ProtocolInfo.a<PacketLoginInListener, PacketDataSerializer> SERVERBOUND_TEMPLATE = ProtocolInfoBuilder.serverboundProtocol(EnumProtocol.LOGIN, (protocolinfobuilder) -> {
    ...
    public static final ProtocolInfo.a<PacketLoginOutListener, PacketDataSerializer> CLIENTBOUND_TEMPLATE = ProtocolInfoBuilder.clientboundProtocol(EnumProtocol.LOGIN, (protocolinfobuilder) -> {

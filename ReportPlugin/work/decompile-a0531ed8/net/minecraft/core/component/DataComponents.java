...
public class DataComponents {
    ...
    public static final DataComponentType<Unit> HIDE_ADDITIONAL_TOOLTIP = register("hide_additional_tooltip", (datacomponenttype_a) -> {
        return datacomponenttype_a.persistent(Unit.CODEC).networkSynchronized(StreamCodec.unit(Unit.INSTANCE));
    });
    ...
    public static final DataComponentType<List<ResourceKey<IRecipe<?>>>> RECIPES = register("recipes", (datacomponenttype_a) -> {
        return datacomponenttype_a.persistent(ResourceKey.codec(Registries.RECIPE).listOf()).cacheEncoding();
    });

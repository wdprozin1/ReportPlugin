...
public class DamageCommand {
    ...
    private static int damage(CommandListenerWrapper commandlistenerwrapper, Entity entity, float f, DamageSource damagesource) throws CommandSyntaxException {
        if (entity.hurtServer(commandlistenerwrapper.getLevel(), damagesource, f)) {
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.damage.success", f, entity.getDisplayName());
            }, true);
            return 1;
        } else {

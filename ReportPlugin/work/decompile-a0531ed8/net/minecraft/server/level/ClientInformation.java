...
public record ClientInformation(String language, int viewDistance, EnumChatVisibility chatVisibility, boolean chatColors, int modelCustomisation, EnumMainHand mainHand, boolean textFilteringEnabled, boolean allowsListing, ParticleStatus particleStatus) {
    ...
    public void write(PacketDataSerializer packetdataserializer) {
        ...
        packetdataserializer.writeEnum(this.particleStatus);
    }

    public static ClientInformation createDefault() {
        return new ClientInformation("en_us", 2, EnumChatVisibility.FULL, true, 0, EntityHuman.DEFAULT_MAIN_HAND, false, false, ParticleStatus.ALL);
    }
}

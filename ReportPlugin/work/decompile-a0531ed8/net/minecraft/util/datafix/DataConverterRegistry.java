...
public class DataConverterRegistry {
    ...
    public static CompletableFuture<?> optimize(Set<TypeReference> set) {
        if (set.isEmpty()) {
            ...
            return DataConverterRegistry.DATA_FIXER.optimize(set, executorservice);
        }
    }
    ...
    private static void addFixers(DataFixerBuilder datafixerbuilder) {
        ...
        datafixerbuilder.addFixer(new EntityFieldsRenameFix(schema163, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing")));
        ...
        Schema schema183 = datafixerbuilder.addSchema(3447, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(DataConverterItemName.create(schema183, "Pottery shard item renaming to Pottery sherd", createRenamer((Map) Stream.of("minecraft:angler_pottery_shard", "minecraft:archer_pottery_shard", "minecraft:arms_up_pottery_shard", "minecraft:blade_pottery_shard", "minecraft:brewer_pottery_shard", "minecraft:burn_pottery_shard", "minecraft:danger_pottery_shard", "minecraft:explorer_pottery_shard", "minecraft:friend_pottery_shard", "minecraft:heart_pottery_shard", "minecraft:heartbreak_pottery_shard", "minecraft:howl_pottery_shard", "minecraft:miner_pottery_shard", "minecraft:mourner_pottery_shard", "minecraft:plenty_pottery_shard", "minecraft:prize_pottery_shard", "minecraft:sheaf_pottery_shard", "minecraft:shelter_pottery_shard", "minecraft:skull_pottery_shard", "minecraft:snort_pottery_shard").collect(Collectors.toMap(Function.identity(), (s) -> {
        ...
        Schema schema185 = datafixerbuilder.addSchema(3450, DataConverterRegistry.SAME_NAMESPACED);
        ...
        Schema schema186 = datafixerbuilder.addSchema(3451, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new ChunkDeleteLightFix(schema186));
        Schema schema187 = datafixerbuilder.addSchema(3459, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new LegacyDragonFightFix(schema187));
        Schema schema188 = datafixerbuilder.addSchema(3564, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new DropInvalidSignDataFix(schema188, "Drop invalid sign datafix data", "minecraft:sign"));
        datafixerbuilder.addFixer(new DropInvalidSignDataFix(schema188, "Drop invalid hanging sign datafix data", "minecraft:hanging_sign"));
        Schema schema189 = datafixerbuilder.addSchema(3565, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new RandomSequenceSettingsFix(schema189));
        Schema schema190 = datafixerbuilder.addSchema(3566, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new ScoreboardDisplaySlotFix(schema190));
        Schema schema191 = datafixerbuilder.addSchema(3568, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new MobEffectIdFix(schema191));
        Schema schema192 = datafixerbuilder.addSchema(3682, V3682::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema192, "Added Crafter", DataConverterTypes.BLOCK_ENTITY));
        Schema schema193 = datafixerbuilder.addSchema(3683, V3683::new);

        datafixerbuilder.addFixer(new PrimedTntBlockStateFixer(schema193));
        Schema schema194 = datafixerbuilder.addSchema(3685, V3685::new);

        datafixerbuilder.addFixer(new FixProjectileStoredItem(schema194));
        Schema schema195 = datafixerbuilder.addSchema(3689, V3689::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema195, "Added Breeze", DataConverterTypes.ENTITY));
        datafixerbuilder.addFixer(new DataConverterAddChoices(schema195, "Added Trial Spawner", DataConverterTypes.BLOCK_ENTITY));
        Schema schema196 = datafixerbuilder.addSchema(3692, DataConverterRegistry.SAME_NAMESPACED);
        UnaryOperator<String> unaryoperator1 = createRenamer(Map.of("minecraft:grass", "minecraft:short_grass"));

        datafixerbuilder.addFixer(DataConverterBlockRename.create(schema196, "Rename grass block to short_grass", unaryoperator1));
        datafixerbuilder.addFixer(DataConverterItemName.create(schema196, "Rename grass item to short_grass", unaryoperator1));
        Schema schema197 = datafixerbuilder.addSchema(3799, V3799::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema197, "Added Armadillo", DataConverterTypes.ENTITY));
        Schema schema198 = datafixerbuilder.addSchema(3800, DataConverterRegistry.SAME_NAMESPACED);
        UnaryOperator<String> unaryoperator2 = createRenamer(Map.of("minecraft:scute", "minecraft:turtle_scute"));

        datafixerbuilder.addFixer(DataConverterItemName.create(schema198, "Rename scute item to turtle_scute", unaryoperator2));
        Schema schema199 = datafixerbuilder.addSchema(3803, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new RenameEnchantmentsFix(schema199, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
        Schema schema200 = datafixerbuilder.addSchema(3807, V3807::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema200, "Added Vault", DataConverterTypes.BLOCK_ENTITY));
        Schema schema201 = datafixerbuilder.addSchema(3807, 1, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new MapBannerBlockPosFormatFix(schema201));
        Schema schema202 = datafixerbuilder.addSchema(3808, V3808::new);

        datafixerbuilder.addFixer(new HorseBodyArmorItemFix(schema202, "minecraft:horse", "ArmorItem", true));
        Schema schema203 = datafixerbuilder.addSchema(3808, 1, V3808_1::new);

        datafixerbuilder.addFixer(new HorseBodyArmorItemFix(schema203, "minecraft:llama", "DecorItem", false));
        Schema schema204 = datafixerbuilder.addSchema(3808, 2, V3808_2::new);

        datafixerbuilder.addFixer(new HorseBodyArmorItemFix(schema204, "minecraft:trader_llama", "DecorItem", false));
        ...
        Schema schema221 = datafixerbuilder.addSchema(3938, V3938::new);

        datafixerbuilder.addFixer(new ProjectileStoredWeaponFix(schema221));
        Schema schema222 = datafixerbuilder.addSchema(3939, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new FeatureFlagRemoveFix(schema222, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
        Schema schema223 = datafixerbuilder.addSchema(3943, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new OptionsMenuBlurrinessFix(schema223));
        Schema schema224 = datafixerbuilder.addSchema(3945, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new AttributeModifierIdFix(schema224));
        datafixerbuilder.addFixer(new JukeboxTicksSinceSongStartedFix(schema224));
        Schema schema225 = datafixerbuilder.addSchema(4054, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new OminousBannerRarityFix(schema225));
        Schema schema226 = datafixerbuilder.addSchema(4055, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new AttributeIdPrefixFix(schema226));
        Schema schema227 = datafixerbuilder.addSchema(4057, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new CarvingStepRemoveFix(schema227));
        Schema schema228 = datafixerbuilder.addSchema(4059, V4059::new);

        datafixerbuilder.addFixer(new FoodToConsumableFix(schema228));
        Schema schema229 = datafixerbuilder.addSchema(4061, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new TrialSpawnerConfigInRegistryFix(schema229));
        Schema schema230 = datafixerbuilder.addSchema(4064, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new FireResistantToDamageResistantComponentFix(schema230));
        Schema schema231 = datafixerbuilder.addSchema(4067, V4067::new);

        datafixerbuilder.addFixer(new BoatSplitFix(schema231));
        datafixerbuilder.addFixer(new FeatureFlagRemoveFix(schema231, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
        Schema schema232 = datafixerbuilder.addSchema(4068, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new LockComponentPredicateFix(schema232));
        datafixerbuilder.addFixer(new ContainerBlockEntityLockPredicateFix(schema232));
        Schema schema233 = datafixerbuilder.addSchema(4070, V4070::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema233, "Added Pale Oak Boat and Pale Oak Chest Boat", DataConverterTypes.ENTITY));
        Schema schema234 = datafixerbuilder.addSchema(4071, V4071::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema234, "Added Creaking", DataConverterTypes.ENTITY));
        datafixerbuilder.addFixer(new DataConverterAddChoices(schema234, "Added Creaking Heart", DataConverterTypes.BLOCK_ENTITY));
        Schema schema235 = datafixerbuilder.addSchema(4081, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EntitySalmonSizeFix(schema235));
        Schema schema236 = datafixerbuilder.addSchema(4173, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EntityFieldsRenameFix(schema236, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
        Schema schema237 = datafixerbuilder.addSchema(4175, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new EquippableAssetRenameFix(schema237));
        datafixerbuilder.addFixer(new CustomModelDataExpandFix(schema237));
        Schema schema238 = datafixerbuilder.addSchema(4176, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new InvalidBlockEntityLockFix(schema238));
        datafixerbuilder.addFixer(new InvalidLockComponentFix(schema238));
        Schema schema239 = datafixerbuilder.addSchema(4180, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new FeatureFlagRemoveFix(schema239, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
        Schema schema240 = datafixerbuilder.addSchema(4181, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema240, "minecraft:furnace"));
        datafixerbuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema240, "minecraft:smoker"));
        datafixerbuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema240, "minecraft:blast_furnace"));
        Schema schema241 = datafixerbuilder.addSchema(4185, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new BlendingDataFix(schema241));

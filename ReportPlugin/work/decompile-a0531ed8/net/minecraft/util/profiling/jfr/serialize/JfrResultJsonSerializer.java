...
public class JfrResultJsonSerializer {
    ...
    private JsonElement structureGen(List<StructureGenStat> list) {
        ...
        ((Map) list.stream().collect(Collectors.groupingBy(StructureGenStat::structureName))).forEach((s, list1) -> {
            ...
            TimedStatSummary<StructureGenStat> timedstatsummary1 = TimedStatSummary.summary(list1);
            ...
            jsonobject.add("fastest", (JsonElement) function.apply((StructureGenStat) timedstatsummary.fastest()));
            jsonobject.add("slowest", (JsonElement) function.apply((StructureGenStat) timedstatsummary.slowest()));
            jsonobject.add("secondSlowest", (JsonElement) (timedstatsummary.secondSlowest() != null ? (JsonElement) function.apply((StructureGenStat) timedstatsummary.secondSlowest()) : JsonNull.INSTANCE));
        });
        return jsonobject;
    }

...
public record AdvancementRewards(int experience, List<ResourceKey<LootTable>> loot, List<ResourceKey<IRecipe<?>>> recipes, Optional<CacheableFunction> function) {
    ...
    public static final Codec<AdvancementRewards> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(Codec.INT.optionalFieldOf("experience", 0).forGetter(AdvancementRewards::experience), ResourceKey.codec(Registries.LOOT_TABLE).listOf().optionalFieldOf("loot", List.of()).forGetter(AdvancementRewards::loot), ResourceKey.codec(Registries.RECIPE).listOf().optionalFieldOf("recipes", List.of()).forGetter(AdvancementRewards::recipes), CacheableFunction.CODEC.optionalFieldOf("function").forGetter(AdvancementRewards::function)).apply(instance, AdvancementRewards::new);
    });
    ...
    public static class a {
        ...
        private final Builder<ResourceKey<IRecipe<?>>> recipes = ImmutableList.builder();

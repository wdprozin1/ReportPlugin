...
public class EntitySubPredicates {
    ...
    public static final EntitySubPredicates.b<EntitySalmon.a> SALMON = register("salmon", EntitySubPredicates.b.create((Codec) EntitySalmon.a.CODEC, (entity) -> {
        Optional optional;

        if (entity instanceof EntitySalmon entitysalmon) {
            optional = Optional.of(entitysalmon.getVariant());
        } else {
            optional = Optional.empty();
        }

...
public class PlayerTrigger extends CriterionTriggerAbstract<PlayerTrigger.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player) implements CriterionTriggerAbstract.a {
        ...
        public static Criterion<PlayerTrigger.a> walkOnBlockWithEquipment(HolderGetter<Block> holdergetter, HolderGetter<Item> holdergetter1, Block block, Item item) {
            return located(CriterionConditionEntity.a.entity().equipment(CriterionConditionEntityEquipment.a.equipment().feet(CriterionConditionItem.a.item().of(holdergetter1, item))).steppingOn(CriterionConditionLocation.a.location().setBlock(CriterionConditionBlock.a.block().of(holdergetter, block))));
        }
    }
}

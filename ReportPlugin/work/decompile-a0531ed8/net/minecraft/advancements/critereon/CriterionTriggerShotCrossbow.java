...
public class CriterionTriggerShotCrossbow extends CriterionTriggerAbstract<CriterionTriggerShotCrossbow.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<CriterionConditionItem> item) implements CriterionTriggerAbstract.a {
        ...
        public static Criterion<CriterionTriggerShotCrossbow.a> shotCrossbow(HolderGetter<Item> holdergetter, IMaterial imaterial) {
            return CriterionTriggers.SHOT_CROSSBOW.createCriterion(new CriterionTriggerShotCrossbow.a(Optional.empty(), Optional.of(CriterionConditionItem.a.item().of(holdergetter, imaterial).build())));
        }

    ...
    public boolean matches(Entity entity, WorldServer worldserver, @Nullable Vec3D vec3d) {
        if (!(entity instanceof EntityPlayer entityplayer)) {
            ...
            while (objectiterator.hasNext()) {
                ...
                if (recipebookserver.contains((ResourceKey) entry.getKey()) != entry.getBooleanValue()) {
                    return false;
                }
            }
            ...
            return !this.input.isPresent() || ((InputPredicate) this.input.get()).matches(entityplayer.getLastClientInput());
        }
    }

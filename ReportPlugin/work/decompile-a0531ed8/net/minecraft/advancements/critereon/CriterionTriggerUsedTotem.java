...
public class CriterionTriggerUsedTotem extends CriterionTriggerAbstract<CriterionTriggerUsedTotem.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<CriterionConditionItem> item) implements CriterionTriggerAbstract.a {
        ...
        public static Criterion<CriterionTriggerUsedTotem.a> usedTotem(HolderGetter<Item> holdergetter, IMaterial imaterial) {
            return CriterionTriggers.USED_TOTEM.createCriterion(new CriterionTriggerUsedTotem.a(Optional.empty(), Optional.of(CriterionConditionItem.a.item().of(holdergetter, imaterial).build())));
        }

...
public class GameTestHarnessHelper {
    ...
    public void assertEntityPresent(EntityTypes<?> entitytypes, AxisAlignedBB axisalignedbb) {
        ...
        List<? extends Entity> list = this.getLevel().getEntities((EntityTypeTest) entitytypes, axisalignedbb1, Entity::isAlive);

        if (list.isEmpty()) {
            throw new GameTestHarnessAssertionPosition("Expected " + entitytypes.toShortString(), BlockPosition.containing(axisalignedbb1.getCenter()), BlockPosition.containing(axisalignedbb.getCenter()), this.testInfo.getTick());
        }
    }
    ...
    public void assertItemEntityCountIs(Item item, BlockPosition blockposition, double d0, int i) {
        ...
        if (j != i) {
            throw new GameTestHarnessAssertionPosition("Expected " + i + " " + item.getName().getString() + " items to exist (found " + j + ")", blockposition1, blockposition, this.testInfo.getTick());
        }
    }
    ...
    public void assertItemEntityPresent(Item item, BlockPosition blockposition, double d0) {
        ...
        do {
            if (!iterator.hasNext()) {
                throw new GameTestHarnessAssertionPosition("Expected " + item.getName().getString() + " item", blockposition1, blockposition, this.testInfo.getTick());
            }
    ...
    public void assertItemEntityNotPresent(Item item, BlockPosition blockposition, double d0) {
        ...
        throw new GameTestHarnessAssertionPosition("Did not expect " + item.getName().getString() + " item", blockposition1, blockposition, this.testInfo.getTick());
    }
    ...
    public void assertItemEntityPresent(Item item) {
        ...
        do {
            if (!iterator.hasNext()) {
                throw new GameTestHarnessAssertion("Expected " + item.getName().getString() + " item");
            }
    ...
    public void assertItemEntityNotPresent(Item item) {
        ...
        throw new GameTestHarnessAssertion("Did not expect " + item.getName().getString() + " item");
    }
    ...
    public void assertEntityNotPresent(EntityTypes<?> entitytypes, AxisAlignedBB axisalignedbb) {
        ...
        if (!list.isEmpty()) {
            throw new GameTestHarnessAssertionPosition("Did not expect " + entitytypes.toShortString(), BlockPosition.containing(axisalignedbb1.getCenter()), BlockPosition.containing(axisalignedbb.getCenter()), this.testInfo.getTick());
        }
    }
    ...
    public <E extends Entity, T> void assertEntityData(BlockPosition blockposition, EntityTypes<E> entitytypes, Function<? super E, T> function, @Nullable T t0) {
        ...
        if (list.isEmpty()) {
            ...
            do {
                ...
                object = function.apply(e0);
            } while (Objects.equals(object, t0));

            String s = String.valueOf(t0);

            throw new GameTestHarnessAssertion("Expected entity data to be: " + s + ", but was: " + String.valueOf(object));
        }
    }
    ...
    public void assertContainerContains(BlockPosition blockposition, Item item) {
        ...
        if (!(tileentity instanceof TileEntityContainer)) {
            MinecraftKey minecraftkey = tileentity != null ? BuiltInRegistries.BLOCK_ENTITY_TYPE.getKey(tileentity.getType()) : null;
            String s = String.valueOf(blockposition);

            throw new GameTestHarnessAssertion("Expected a container at " + s + ", found " + String.valueOf(minecraftkey));

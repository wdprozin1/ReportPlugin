...
public interface DamageTypes {
    ...
    ResourceKey<DamageType> ENDER_PEARL = ResourceKey.create(Registries.DAMAGE_TYPE, MinecraftKey.withDefaultNamespace("ender_pearl"));
    ...
    ResourceKey<DamageType> MACE_SMASH = ResourceKey.create(Registries.DAMAGE_TYPE, MinecraftKey.withDefaultNamespace("mace_smash"));
    ...
    static void bootstrap(BootstrapContext<DamageType> bootstrapcontext) {
        ...
        bootstrapcontext.register(DamageTypes.ENDER_PEARL, new DamageType("fall", DamageScaling.WHEN_CAUSED_BY_LIVING_NON_PLAYER, 0.0F, DamageEffects.HURT, DeathMessageType.FALL_VARIANTS));
        ...
        bootstrapcontext.register(DamageTypes.MACE_SMASH, new DamageType("mace_smash", 0.1F));
    }
}

...
public class IScoreboardCriteria {
    ...
    public static enum EnumScoreboardHealthDisplay implements INamable {
        ...
        public static IScoreboardCriteria.EnumScoreboardHealthDisplay byId(String s) {
            return (IScoreboardCriteria.EnumScoreboardHealthDisplay) IScoreboardCriteria.EnumScoreboardHealthDisplay.CODEC.byName(s, (Enum) IScoreboardCriteria.EnumScoreboardHealthDisplay.INTEGER);
        }
    }
}

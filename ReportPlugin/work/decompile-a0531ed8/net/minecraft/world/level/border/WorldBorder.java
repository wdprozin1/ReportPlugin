...
public class WorldBorder {
    ...
    public boolean isWithinBounds(AxisAlignedBB axisalignedbb) {
        return this.isWithinBounds(axisalignedbb.minX, axisalignedbb.minZ, axisalignedbb.maxX - 9.999999747378752E-6D, axisalignedbb.maxZ - 9.999999747378752E-6D);
    }
    ...
    public Vec3D clampVec3ToBound(double d0, double d1, double d2) {
        return new Vec3D(MathHelper.clamp(d0, this.getMinX(), this.getMaxX() - 9.999999747378752E-6D), d1, MathHelper.clamp(d2, this.getMinZ(), this.getMaxZ() - 9.999999747378752E-6D));
    }

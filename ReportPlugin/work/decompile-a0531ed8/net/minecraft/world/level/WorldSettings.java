...
public final class WorldSettings {
    ...
    public static WorldSettings parse(Dynamic<?> dynamic, WorldDataConfiguration worlddataconfiguration) {
        ...
        }).result().orElse(EnumDifficulty.NORMAL), dynamic.get("allowCommands").asBoolean(enumgamemode == EnumGamemode.CREATIVE), new GameRules(worlddataconfiguration.enabledFeatures(), dynamic.get("GameRules")), worlddataconfiguration);
    }

...
public class MaterialMapColor {
    ...
    public int calculateARGBColor(MaterialMapColor.a materialmapcolor_a) {
        return this == MaterialMapColor.NONE ? 0 : ARGB.scaleRGB(ARGB.opaque(this.col), materialmapcolor_a.modifier);
    }
    ...
    public static int getColorFromPackedId(int i) {
        ...
        return byIdUnsafe(j >> 2).calculateARGBColor(MaterialMapColor.a.byIdUnsafe(j & 3));
    }
    ...
    public static enum a {
        ...
        private a(final int i, final int j) {
            this.id = i;
            this.modifier = j;
        }

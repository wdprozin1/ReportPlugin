...
public class LootTables {
    ...
    public static final Map<EnumColor, ResourceKey<LootTable>> SHEEP_BY_DYE = (Map) SystemUtils.make(new EnumMap(EnumColor.class), (enummap) -> {
        makeDyeKeyMap(enummap, "entities/sheep");
    });
    ...
    public static final Map<EnumColor, ResourceKey<LootTable>> SHEAR_SHEEP_BY_DYE = (Map) SystemUtils.make(new EnumMap(EnumColor.class), (enummap) -> {
        makeDyeKeyMap(enummap, "shearing/sheep");
    });
    ...
    private static void makeDyeKeyMap(EnumMap<EnumColor, ResourceKey<LootTable>> enummap, String s) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            enummap.put(enumcolor, register(s + "/" + enumcolor.getName()));
        }

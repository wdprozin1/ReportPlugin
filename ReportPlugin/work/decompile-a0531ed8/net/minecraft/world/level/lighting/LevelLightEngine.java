...
public class LevelLightEngine implements ILightEngine {
    ...
    public boolean lightOnInColumn(long i) {
        return this.blockEngine == null || this.blockEngine.storage.lightOnInColumn(i) && (this.skyEngine == null || this.skyEngine.storage.lightOnInColumn(i));
    }

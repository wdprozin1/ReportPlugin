    ...
    public abstract static class BlockData extends IBlockDataHolder<Block, IBlockData> {
        ...
        public void initCache() {
            ...
            if (this.occlusionShape.isEmpty()) {
                ...
                EnumDirection[] aenumdirection = BlockBase.BlockData.DIRECTIONS;
        ...
        public VoxelShape getEntityInsideCollisionShape(World world, BlockPosition blockposition) {
            return this.getBlock().getEntityInsideCollisionShape(this.asState(), world, blockposition);
        }
            ...
            Cache(IBlockData iblockdata) {
                ...
                if (!this.collisionShape.isEmpty() && iblockdata.hasOffsetFunction()) {
                    ...
                    for (int j = 0; j < i; ++j) {
                        ...
                        for (int l = 0; l < k; ++l) {
                            EnumBlockSupport enumblocksupport = aenumblocksupport[l];

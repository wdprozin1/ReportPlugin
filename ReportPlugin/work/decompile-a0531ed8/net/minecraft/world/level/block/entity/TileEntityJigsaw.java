...
public class TileEntityJigsaw extends TileEntity {
    ...
    protected void loadAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        this.joint = DefinedStructure.getJointType(nbttagcompound, this.getBlockState());
    ...
    public static enum JointType implements INamable {
        ...
        public static final INamable.a<TileEntityJigsaw.JointType> CODEC = INamable.fromEnum(TileEntityJigsaw.JointType::values);

...
public class BlockTripwireHook extends Block {
        ...
        if (optional.isPresent()) {
            ...
            if (flag2 != flag4) {
                for (int l = 1; l < j; ++l) {
                    ...
                    if (iblockdata4 != null) {
                        IBlockData iblockdata5 = world.getBlockState(blockposition2);
    ...
    protected void onRemove(IBlockData iblockdata, World world, BlockPosition blockposition, IBlockData iblockdata1, boolean flag) {
        if (!flag && !iblockdata.is(iblockdata1.getBlock())) {
            ...
            if (flag2) {
                notifyNeighbors(this, world, blockposition, (EnumDirection) iblockdata.getValue(BlockTripwireHook.FACING));
            }

...
public class TrialSpawnerBlockEntity extends TileEntity implements Spawner, TrialSpawner.b {
    ...
    protected void loadAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        DataResult dataresult = this.trialSpawner.codec().parse(holderlookup_a.createSerializationContext(DynamicOpsNBT.INSTANCE), nbttagcompound);
    ...
    protected void saveAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        this.trialSpawner.codec().encodeStart(holderlookup_a.createSerializationContext(DynamicOpsNBT.INSTANCE), this.trialSpawner).ifSuccess((nbtbase) -> {

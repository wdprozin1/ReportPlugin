...
public class BlockProperties {
    ...
    public static final BlockStateBoolean ACTIVE = BlockStateBoolean.create("active");
    ...
    public static final BlockStateEnum<EnumDirection> FACING = BlockStateEnum.create("facing", EnumDirection.class, (Enum[])(EnumDirection.NORTH, EnumDirection.EAST, EnumDirection.SOUTH, EnumDirection.WEST, EnumDirection.UP, EnumDirection.DOWN));
    ...
    public static final BlockStateEnum<EnumDirection> HORIZONTAL_FACING = BlockStateEnum.create("facing", EnumDirection.class, (Predicate) EnumDirection.EnumDirectionLimit.HORIZONTAL);
    ...
    public static final BlockStateEnum<EnumDirection> VERTICAL_DIRECTION = BlockStateEnum.create("vertical_direction", EnumDirection.class, (Enum[])(EnumDirection.UP, EnumDirection.DOWN));
    ...
    public static final BlockStateEnum<VaultState> VAULT_STATE = BlockStateEnum.create("vault_state", VaultState.class);

...
public final class TrialSpawner {
    ...
    public void overrideEntityToSpawn(EntityTypes<?> entitytypes, World world) {
        this.data.reset();
        this.normalConfig = Holder.direct(((TrialSpawnerConfig) this.normalConfig.value()).withSpawning(entitytypes));
        this.ominousConfig = Holder.direct(((TrialSpawnerConfig) this.ominousConfig.value()).withSpawning(entitytypes));

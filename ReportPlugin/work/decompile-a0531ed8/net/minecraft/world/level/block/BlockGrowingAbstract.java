...
public abstract class BlockGrowingAbstract extends Block {
    ...
    public IBlockData getStateForPlacement(BlockActionContext blockactioncontext) {
        ...
        return !iblockdata.is((Block) this.getHeadBlock()) && !iblockdata.is(this.getBodyBlock()) ? this.getStateForPlacement(blockactioncontext.getLevel().random) : this.getBodyBlock().defaultBlockState();
    }

...
public class MultifaceGrowthConfiguration implements WorldGenFeatureConfiguration {
    ...
    public MultifaceGrowthConfiguration(MultifaceSpreadeableBlock multifacespreadeableblock, int i, boolean flag, boolean flag1, boolean flag2, float f, HolderSet<Block> holderset) {

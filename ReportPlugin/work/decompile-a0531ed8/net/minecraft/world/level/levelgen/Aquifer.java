                ...
                if (aquifer_b.at(j).is(Blocks.LAVA)) {
                    ...
                    if (d1 <= 0.0D) {
                        ...
                        if (d0 + d2 > 0.0D) {
                            ...
                            if (d3 > 0.0D) {
                                d4 = d1 * d3 * this.calculatePressure(densityfunction_b, mutabledouble, aquifer_b1, aquifer_b4);
                                if (d0 + d4 > 0.0D) {
                                    this.shouldScheduleFluidUpdate = false;
                                    return null;
                                }
                            ...
                            d4 = similarity(l1, i2);
                            if (d4 > 0.0D) {
                                double d5 = d1 * d4 * this.calculatePressure(densityfunction_b, mutabledouble, aquifer_b3, aquifer_b4);
                            ...
                            boolean flag1 = d4 >= Aquifer.c.FLOWING_UPDATE_SIMULARITY && !aquifer_b3.equals(aquifer_b4);

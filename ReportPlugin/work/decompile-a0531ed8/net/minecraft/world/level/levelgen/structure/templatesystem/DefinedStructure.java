...
public class DefinedStructure {
    ...
    public NBTTagCompound save(NBTTagCompound nbttagcompound) {
        if (this.palettes.isEmpty()) {
            ...
            if (list.size() == 1) {
                ...
                while (iterator.hasNext()) {
                    DefinedStructure.c definedstructure_c2 = (DefinedStructure.c) iterator.next();
    ...
    private void loadPalette(HolderGetter<Block> holdergetter, NBTTagList nbttaglist, NBTTagList nbttaglist1) {
        ...
        for (int i = 0; i < nbttaglist.size(); ++i) {
            definedstructure_c.addMapping(GameProfileSerializer.readBlockState(holdergetter, nbttaglist.getCompound(i)), i);
        }
        ...
        for (int j = 0; j < nbttaglist1.size(); ++j) {
            ...
            IBlockData iblockdata = definedstructure_c.stateFor(nbttagcompound.getInt("state"));
    ...
    public static TileEntityJigsaw.JointType getJointType(NBTTagCompound nbttagcompound, IBlockData iblockdata) {
        return (TileEntityJigsaw.JointType) TileEntityJigsaw.JointType.CODEC.byName(nbttagcompound.getString("joint"), () -> {
    ...
    public static record a(DefinedStructure.BlockInfo info, TileEntityJigsaw.JointType jointType, MinecraftKey name, MinecraftKey pool, MinecraftKey target, int placementPriority, int selectionPriority) {
        ...
        public static DefinedStructure.a of(DefinedStructure.BlockInfo definedstructure_blockinfo) {
            ...
            return new DefinedStructure.a(definedstructure_blockinfo, DefinedStructure.getJointType(nbttagcompound, definedstructure_blockinfo.state()), MinecraftKey.parse(nbttagcompound.getString("name")), MinecraftKey.parse(nbttagcompound.getString("pool")), MinecraftKey.parse(nbttagcompound.getString("target")), nbttagcompound.getInt("placement_priority"), nbttagcompound.getInt("selection_priority"));
        }

    ...
    public static class i extends DefinedStructurePiece {
        ...
        protected void handleDataMarker(String s, BlockPosition blockposition, WorldAccess worldaccess, RandomSource randomsource, StructureBoundingBox structureboundingbox) {
            if (s.startsWith("Chest")) {
                ...
                switch (s) {
                    case "Mage":
                        list.add((EntityInsentient) EntityTypes.EVOKER.create(worldaccess.getLevel(), EntitySpawnReason.STRUCTURE));
                        break;
                    case "Warrior":
                        list.add((EntityInsentient) EntityTypes.VINDICATOR.create(worldaccess.getLevel(), EntitySpawnReason.STRUCTURE));
                        break;
                    case "Group of Allays":
                        ...
                        while (true) {
                            ...
                            list.add((EntityInsentient) EntityTypes.ALLAY.create(worldaccess.getLevel(), EntitySpawnReason.STRUCTURE));
                            ++j;
                        }
                    default:
                        return;

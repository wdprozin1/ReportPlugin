...
public class NoiseThresholdProvider extends NoiseBasedStateProvider {
    ...
    public static final MapCodec<NoiseThresholdProvider> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        ...
        }), ExtraCodecs.nonEmptyList(IBlockData.CODEC.listOf()).fieldOf("low_states").forGetter((noisethresholdprovider) -> {
            return noisethresholdprovider.lowStates;
        }), ExtraCodecs.nonEmptyList(IBlockData.CODEC.listOf()).fieldOf("high_states").forGetter((noisethresholdprovider) -> {

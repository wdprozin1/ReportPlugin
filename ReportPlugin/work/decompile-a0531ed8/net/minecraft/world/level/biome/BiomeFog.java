...
public class BiomeFog {
    ...
    public static final Codec<BiomeFog> CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        }), SimpleWeightedRandomList.wrappedCodecAllowingEmpty(Music.CODEC).optionalFieldOf("music").forGetter((biomefog) -> {
    ...
    BiomeFog(int i, int j, int k, int l, Optional<Integer> optional, Optional<Integer> optional1, BiomeFog.GrassColor biomefog_grasscolor, Optional<BiomeParticles> optional2, Optional<Holder<SoundEffect>> optional3, Optional<CaveSoundSettings> optional4, Optional<CaveSound> optional5, Optional<SimpleWeightedRandomList<Music>> optional6, float f) {
        this.fogColor = i;
        this.waterColor = j;
    ...
    public static class a {
        ...
        public BiomeFog.a backgroundMusic(@Nullable Music music) {
            if (music == null) {
                ...
                this.backgroundMusic = Optional.of(SimpleWeightedRandomList.single(music));
                return this;
            }
        }
        ...
        public BiomeFog.a backgroundMusic(SimpleWeightedRandomList<Music> simpleweightedrandomlist) {

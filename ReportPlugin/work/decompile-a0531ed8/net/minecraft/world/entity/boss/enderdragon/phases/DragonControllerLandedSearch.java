...
public class DragonControllerLandedSearch extends AbstractDragonControllerLanded {
    ...
    public void doServerTick(WorldServer worldserver) {
        ++this.scanningTime;
        EntityHuman entityhuman = worldserver.getNearestPlayer(this.scanTargeting, this.dragon, this.dragon.getX(), this.dragon.getY(), this.dragon.getZ());
        ...
        if (entityhuman != null) {
            ...
            entityhuman = worldserver.getNearestPlayer(DragonControllerLandedSearch.CHARGE_TARGETING, this.dragon, this.dragon.getX(), this.dragon.getY(), this.dragon.getZ());

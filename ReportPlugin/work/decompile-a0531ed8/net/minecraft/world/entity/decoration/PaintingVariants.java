...
public class PaintingVariants {
    ...
    public static void bootstrap(BootstrapContext<PaintingVariant> bootstrapcontext) {
        ...
        register(bootstrapcontext, PaintingVariants.WITHER, 2, 2, false);
        ...
        register(bootstrapcontext, PaintingVariants.EARTH, 2, 2, false);
        register(bootstrapcontext, PaintingVariants.WIND, 2, 2, false);
        register(bootstrapcontext, PaintingVariants.WATER, 2, 2, false);
        register(bootstrapcontext, PaintingVariants.FIRE, 2, 2, false);
    ...
    private static void register(BootstrapContext<PaintingVariant> bootstrapcontext, ResourceKey<PaintingVariant> resourcekey, int i, int j, boolean flag) {
        bootstrapcontext.register(resourcekey, new PaintingVariant(i, j, resourcekey.location(), Optional.of(IChatBaseComponent.translatable(resourcekey.location().toLanguageKey("painting", "title")).withStyle(EnumChatFormat.YELLOW)), flag ? Optional.of(IChatBaseComponent.translatable(resourcekey.location().toLanguageKey("painting", "author")).withStyle(EnumChatFormat.GRAY)) : Optional.empty()));
    }

    ...
    private class c extends EntityIllagerWizard.PathfinderGoalCastSpell {
        ...
        protected void performSpellCasting() {
            ...
            for (int i = 0; i < 3; ++i) {
                ...
                EntityVex entityvex = (EntityVex) EntityTypes.VEX.create(EntityEvoker.this.level(), EntitySpawnReason.MOB_SUMMONED);
    ...
    private class a extends EntityIllagerWizard.PathfinderGoalCastSpell {
        ...
        private void createSpellEntity(double d0, double d1, double d2, double d3, float f, int i) {
            ...
            if (flag) {
                ...
                EntityEvoker.this.level().gameEvent((Holder) GameEvent.ENTITY_PLACE, new Vec3D(d0, (double) blockposition.getY() + d4, d1), GameEvent.a.of((Entity) EntityEvoker.this));
            }
        ...
        public boolean canUse() {
            if (EntityEvoker.this.getTarget() != null) {
                ...
                if (!worldserver.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING)) {
                    ...
                    List<EntitySheep> list = worldserver.getNearbyEntities(EntitySheep.class, this.wololoTargeting, EntityEvoker.this, EntityEvoker.this.getBoundingBox().inflate(16.0D, 4.0D, 16.0D));

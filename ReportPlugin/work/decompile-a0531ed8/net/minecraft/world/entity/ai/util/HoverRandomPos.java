        ...
        return RandomPositionGenerator.generateRandomPos(entitycreature, () -> {
            ...
            if (blockposition == null) {
                ...
                if (blockposition1 == null) {
                    ...
                    blockposition1 = RandomPositionGenerator.moveUpToAboveSolid(blockposition1, entitycreature.getRandom().nextInt(k - l + 1) + l, entitycreature.level().getMaxY(), (blockposition2) -> {

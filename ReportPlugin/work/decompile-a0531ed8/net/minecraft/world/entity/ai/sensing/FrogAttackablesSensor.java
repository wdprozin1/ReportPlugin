...
public class FrogAttackablesSensor extends NearestVisibleLivingEntitySensor {
    ...
    protected boolean isMatchingEntity(WorldServer worldserver, EntityLiving entityliving, EntityLiving entityliving1) {
        return !entityliving.getBrain().hasMemoryValue(MemoryModuleType.HAS_HUNTING_COOLDOWN) && Sensor.isEntityAttackable(worldserver, entityliving, entityliving1) && Frog.canEat(entityliving1) && !this.isUnreachableAttackTarget(entityliving, entityliving1) ? entityliving1.closerThan(entityliving, 10.0D) : false;
    }

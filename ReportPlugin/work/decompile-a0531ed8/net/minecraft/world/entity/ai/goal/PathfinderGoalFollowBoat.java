...
public class PathfinderGoalFollowBoat extends PathfinderGoal {
    ...
    public boolean canUse() {
        List<AbstractBoat> list = this.mob.level().getEntitiesOfClass(AbstractBoat.class, this.mob.getBoundingBox().inflate(5.0D));
        boolean flag = false;
        Iterator iterator = list.iterator();

        while (iterator.hasNext()) {
            AbstractBoat abstractboat = (AbstractBoat) iterator.next();

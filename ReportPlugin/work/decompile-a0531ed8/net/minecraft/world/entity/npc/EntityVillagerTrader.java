...
public class EntityVillagerTrader extends EntityVillagerAbstract implements Consumable.b {
    ...
    private void experimentalUpdateTrades() {
        ...
        while (iterator.hasNext()) {
            Pair<VillagerTrades.IMerchantRecipeOption[], Integer> pair = (Pair) iterator.next();
    ...
    public void addAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        if (this.wanderTarget != null) {
            nbttagcompound.put("wander_target", GameProfileSerializer.writeBlockPos(this.wanderTarget));
        }
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        GameProfileSerializer.readBlockPos(nbttagcompound, "wander_target").ifPresent((blockposition) -> {

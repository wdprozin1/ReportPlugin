...
public class VillagerTrades {
    ...
    public static final Int2ObjectMap<VillagerTrades.IMerchantRecipeOption[]> WANDERING_TRADER_TRADES = toIntMap(ImmutableMap.of(1, new VillagerTrades.IMerchantRecipeOption[]{new VillagerTrades.i(Items.SEA_PICKLE, 2, 1, 5, 1), new VillagerTrades.i(Items.SLIME_BALL, 4, 1, 5, 1), new VillagerTrades.i(Items.GLOWSTONE, 2, 1, 5, 1), new VillagerTrades.i(Items.NAUTILUS_SHELL, 5, 1, 5, 1), new VillagerTrades.i(Items.FERN, 1, 1, 12, 1), new VillagerTrades.i(Items.SUGAR_CANE, 1, 1, 8, 1), new VillagerTrades.i(Items.PUMPKIN, 1, 1, 4, 1), new VillagerTrades.i(Items.KELP, 3, 1, 12, 1), new VillagerTrades.i(Items.CACTUS, 3, 1, 8, 1), new VillagerTrades.i(Items.DANDELION, 1, 1, 12, 1), new VillagerTrades.i(Items.POPPY, 1, 1, 12, 1), new VillagerTrades.i(Items.BLUE_ORCHID, 1, 1, 8, 1), new VillagerTrades.i(Items.ALLIUM, 1, 1, 12, 1), new VillagerTrades.i(Items.AZURE_BLUET, 1, 1, 12, 1), new VillagerTrades.i(Items.RED_TULIP, 1, 1, 12, 1), new VillagerTrades.i(Items.ORANGE_TULIP, 1, 1, 12, 1), new VillagerTrades.i(Items.WHITE_TULIP, 1, 1, 12, 1), new VillagerTrades.i(Items.PINK_TULIP, 1, 1, 12, 1), new VillagerTrades.i(Items.OXEYE_DAISY, 1, 1, 12, 1), new VillagerTrades.i(Items.CORNFLOWER, 1, 1, 12, 1), new VillagerTrades.i(Items.LILY_OF_THE_VALLEY, 1, 1, 7, 1), new VillagerTrades.i(Items.OPEN_EYEBLOSSOM, 1, 1, 7, 1), new VillagerTrades.i(Items.WHEAT_SEEDS, 1, 1, 12, 1), new VillagerTrades.i(Items.BEETROOT_SEEDS, 1, 1, 12, 1), new VillagerTrades.i(Items.PUMPKIN_SEEDS, 1, 1, 12, 1), new VillagerTrades.i(Items.MELON_SEEDS, 1, 1, 12, 1), new VillagerTrades.i(Items.ACACIA_SAPLING, 5, 1, 8, 1), new VillagerTrades.i(Items.BIRCH_SAPLING, 5, 1, 8, 1), new VillagerTrades.i(Items.DARK_OAK_SAPLING, 5, 1, 8, 1), new VillagerTrades.i(Items.JUNGLE_SAPLING, 5, 1, 8, 1), new VillagerTrades.i(Items.OAK_SAPLING, 5, 1, 8, 1), new VillagerTrades.i(Items.SPRUCE_SAPLING, 5, 1, 8, 1), new VillagerTrades.i(Items.CHERRY_SAPLING, 5, 1, 8, 1), new VillagerTrades.i(Items.PALE_OAK_SAPLING, 5, 1, 8, 1), new VillagerTrades.i(Items.MANGROVE_PROPAGULE, 5, 1, 8, 1), new VillagerTrades.i(Items.RED_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.WHITE_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.BLUE_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.PINK_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.BLACK_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.GREEN_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.LIGHT_GRAY_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.MAGENTA_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.YELLOW_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.GRAY_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.PURPLE_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.LIGHT_BLUE_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.LIME_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.ORANGE_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.BROWN_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.CYAN_DYE, 1, 3, 12, 1), new VillagerTrades.i(Items.BRAIN_CORAL_BLOCK, 3, 1, 8, 1), new VillagerTrades.i(Items.BUBBLE_CORAL_BLOCK, 3, 1, 8, 1), new VillagerTrades.i(Items.FIRE_CORAL_BLOCK, 3, 1, 8, 1), new VillagerTrades.i(Items.HORN_CORAL_BLOCK, 3, 1, 8, 1), new VillagerTrades.i(Items.TUBE_CORAL_BLOCK, 3, 1, 8, 1), new VillagerTrades.i(Items.VINE, 1, 1, 12, 1), new VillagerTrades.i(Items.PALE_HANGING_MOSS, 1, 1, 12, 1), new VillagerTrades.i(Items.BROWN_MUSHROOM, 1, 1, 12, 1), new VillagerTrades.i(Items.RED_MUSHROOM, 1, 1, 12, 1), new VillagerTrades.i(Items.LILY_PAD, 1, 2, 5, 1), new VillagerTrades.i(Items.SMALL_DRIPLEAF, 1, 2, 5, 1), new VillagerTrades.i(Items.SAND, 1, 8, 8, 1), new VillagerTrades.i(Items.RED_SAND, 1, 4, 6, 1), new VillagerTrades.i(Items.POINTED_DRIPSTONE, 1, 2, 5, 1), new VillagerTrades.i(Items.ROOTED_DIRT, 1, 2, 5, 1), new VillagerTrades.i(Items.MOSS_BLOCK, 1, 2, 5, 1), new VillagerTrades.i(Items.PALE_MOSS_BLOCK, 1, 2, 5, 1)}, 2, new VillagerTrades.IMerchantRecipeOption[]{new VillagerTrades.i(Items.TROPICAL_FISH_BUCKET, 5, 1, 4, 1), new VillagerTrades.i(Items.PUFFERFISH_BUCKET, 5, 1, 4, 1), new VillagerTrades.i(Items.PACKED_ICE, 3, 1, 6, 1), new VillagerTrades.i(Items.BLUE_ICE, 6, 1, 6, 1), new VillagerTrades.i(Items.GUNPOWDER, 1, 1, 8, 1), new VillagerTrades.i(Items.PODZOL, 3, 3, 6, 1)}));

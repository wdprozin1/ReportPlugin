...
public class Allay extends EntityCreature implements InventoryCarrier, VibrationSystem {
    ...
    public static AttributeProvider.Builder createAttributes() {
        return EntityInsentient.createMobAttributes().add(GenericAttributes.MAX_HEALTH, 20.0D).add(GenericAttributes.FLYING_SPEED, 0.10000000149011612D).add(GenericAttributes.MOVEMENT_SPEED, 0.10000000149011612D).add(GenericAttributes.ATTACK_DAMAGE, 2.0D);
    }

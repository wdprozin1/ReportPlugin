...
public class Frog extends EntityAnimal implements VariantHolder<Holder<FrogVariant>> {
    ...
    protected void defineSynchedData(DataWatcher.a datawatcher_a) {
        ...
        datawatcher_a.define(Frog.DATA_VARIANT_ID, BuiltInRegistries.FROG_VARIANT.getOrThrow(Frog.DEFAULT_VARIANT));
    ...
    public void playEatingSound() {
        this.level().playSound((EntityHuman) null, (Entity) this, SoundEffects.FROG_EAT, SoundCategory.NEUTRAL, 2.0F, 1.0F);
    }

    @Nullable
    @Override
    public EntityAgeable getBreedOffspring(WorldServer worldserver, EntityAgeable entityageable) {
        Frog frog = (Frog) EntityTypes.FROG.create(worldserver, EntitySpawnReason.BREEDING);
    ...
    public GroupDataEntity finalizeSpawn(WorldAccess worldaccess, DifficultyDamageScaler difficultydamagescaler, EntitySpawnReason entityspawnreason, @Nullable GroupDataEntity groupdataentity) {
        ...
        if (holder.is(BiomeTags.SPAWNS_COLD_VARIANT_FROGS)) {
            ...
            this.setVariant((Holder) BuiltInRegistries.FROG_VARIANT.getOrThrow(Frog.DEFAULT_VARIANT));
        }

...
public class EntityHorse extends EntityHorseAbstract implements VariantHolder<HorseColor> {
    ...
    public EntityAgeable getBreedOffspring(WorldServer worldserver, EntityAgeable entityageable) {
        if (entityageable instanceof EntityHorseDonkey) {
            EntityHorseMule entityhorsemule = (EntityHorseMule) EntityTypes.MULE.create(worldserver, EntitySpawnReason.BREEDING);
            ...
            EntityHorse entityhorse1 = (EntityHorse) EntityTypes.HORSE.create(worldserver, EntitySpawnReason.BREEDING);

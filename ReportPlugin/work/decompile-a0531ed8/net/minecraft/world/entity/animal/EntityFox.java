...
public class EntityFox extends EntityAnimal implements VariantHolder<EntityFox.Type> {
    ...
    protected void defineSynchedData(DataWatcher.a datawatcher_a) {
        ...
        datawatcher_a.define(EntityFox.DATA_TYPE_ID, 0);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new EntityFox.e(this, 1.0D));
    ...
    public static AttributeProvider.Builder createAttributes() {
        return EntityAnimal.createAnimalAttributes().add(GenericAttributes.MOVEMENT_SPEED, 0.30000001192092896D).add(GenericAttributes.MAX_HEALTH, 10.0D).add(GenericAttributes.ATTACK_DAMAGE, 2.0D).add(GenericAttributes.SAFE_FALL_DISTANCE, 5.0D).add(GenericAttributes.FOLLOW_RANGE, 32.0D);
    }

    @Nullable
    @Override
    public EntityFox getBreedOffspring(WorldServer worldserver, EntityAgeable entityageable) {
        EntityFox entityfox = (EntityFox) EntityTypes.FOX.create(worldserver, EntitySpawnReason.BREEDING);
    ...
    List<UUID> getTrustedUUIDs() {
        Optional<UUID> optional = (Optional) this.entityData.get(EntityFox.DATA_TRUSTED_ID_0);
        Optional<UUID> optional1 = (Optional) this.entityData.get(EntityFox.DATA_TRUSTED_ID_1);
    ...
    private class e extends PathfinderGoalBreed {
        ...
        public e(final EntityFox entityfox, final double d0) {
            super(entityfox, d0);
        }
    ...
    public class f extends PathfinderGoalGotoTarget {
        ...
        private void pickSweetBerries(IBlockData iblockdata) {
            ...
            EntityFox.this.level().gameEvent((Holder) GameEvent.BLOCK_CHANGE, this.blockPos, GameEvent.a.of((Entity) EntityFox.this));
        }

...
public class EntityDolphin extends AgeableWaterCreature {
    ...
    public EntityDolphin getBreedOffspring(WorldServer worldserver, EntityAgeable entityageable) {
        return (EntityDolphin) EntityTypes.DOLPHIN.create(worldserver, EntitySpawnReason.BREEDING);
    }
    ...
    protected void defineSynchedData(DataWatcher.a datawatcher_a) {
        ...
        datawatcher_a.define(EntityDolphin.TREASURE_POS, BlockPosition.ZERO);

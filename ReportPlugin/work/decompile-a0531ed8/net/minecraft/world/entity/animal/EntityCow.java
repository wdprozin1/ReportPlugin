...
public class EntityCow extends EntityAnimal {
    ...
    public static AttributeProvider.Builder createAttributes() {
        return EntityAnimal.createAnimalAttributes().add(GenericAttributes.MAX_HEALTH, 10.0D).add(GenericAttributes.MOVEMENT_SPEED, 0.20000000298023224D);
    }
    ...
    public EntityCow getBreedOffspring(WorldServer worldserver, EntityAgeable entityageable) {
        return (EntityCow) EntityTypes.COW.create(worldserver, EntitySpawnReason.BREEDING);
    }

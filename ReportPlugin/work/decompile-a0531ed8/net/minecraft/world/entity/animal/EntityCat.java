...
public class EntityCat extends EntityTameableAnimal implements VariantHolder<Holder<CatVariant>> {
    ...
    protected void defineSynchedData(DataWatcher.a datawatcher_a) {
        ...
        datawatcher_a.define(EntityCat.DATA_VARIANT_ID, BuiltInRegistries.CAT_VARIANT.getOrThrow(EntityCat.DEFAULT_VARIANT));
    ...
    private void handleLieDown() {
        ...
        if (this.isLying()) {
            ...
            List<EntityHuman> list = this.level().getEntitiesOfClass(EntityHuman.class, (new AxisAlignedBB(blockposition)).inflate(2.0D, 2.0D, 2.0D));
    ...
    public EntityCat getBreedOffspring(WorldServer worldserver, EntityAgeable entityageable) {
        EntityCat entitycat = (EntityCat) EntityTypes.CAT.create(worldserver, EntitySpawnReason.BREEDING);

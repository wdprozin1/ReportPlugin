...
public class Axolotl extends EntityAnimal implements VariantHolder<Axolotl.Variant>, Bucketable {
    ...
    public EntityAgeable getBreedOffspring(WorldServer worldserver, EntityAgeable entityageable) {
        Axolotl axolotl = (Axolotl) EntityTypes.AXOLOTL.create(worldserver, EntitySpawnReason.BREEDING);
        ...
        if (entityliving.isDeadOrDying()) {
            ...
            if (damagesource != null) {
                ...
                if (entity != null && entity.getType() == EntityTypes.PLAYER) {
                    ...
                    List<EntityHuman> list = worldserver.getEntitiesOfClass(EntityHuman.class, axolotl.getBoundingBox().inflate(20.0D));

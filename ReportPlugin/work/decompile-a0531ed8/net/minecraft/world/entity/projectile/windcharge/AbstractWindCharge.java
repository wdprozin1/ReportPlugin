...
public abstract class AbstractWindCharge extends EntityFireball implements ItemSupplier {
    ...
    protected AxisAlignedBB makeBoundingBox(Vec3D vec3d) {
        ...
        return new AxisAlignedBB(vec3d.x - (double) f, vec3d.y - 0.15000000596046448D, vec3d.z - (double) f, vec3d.x + (double) f, vec3d.y - 0.15000000596046448D + (double) f1, vec3d.z + (double) f);
    }

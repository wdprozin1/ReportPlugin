...
public class AxisAlignedBB {
    ...
    public boolean collidedAlongVector(Vec3D vec3d, List<AxisAlignedBB> list) {
        ...
        do {
            ...
            axisalignedbb = axisalignedbb1.inflate(this.getXsize() * 0.5D, this.getYsize() * 0.5D, this.getZsize() * 0.5D);
            if (axisalignedbb.contains(vec3d2) || axisalignedbb.contains(vec3d1)) {
                return true;
            }
        } while (!axisalignedbb.clip(vec3d1, vec3d2).isPresent());

...
public class RecipeMapExtend extends ShapedRecipes {
    ...
    public RecipeMapExtend(CraftingBookCategory craftingbookcategory) {
        super("", craftingbookcategory, ShapedRecipePattern.of(Map.of('#', RecipeItemStack.of((IMaterial) Items.PAPER), 'x', RecipeItemStack.of((IMaterial) Items.FILLED_MAP)), "###", "#x#", "###"), new ItemStack(Items.MAP));
    }
    ...
    @Override
    public RecipeSerializer<RecipeMapExtend> getSerializer() {

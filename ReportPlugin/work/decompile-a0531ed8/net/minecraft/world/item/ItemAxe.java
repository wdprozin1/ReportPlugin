...
public class ItemAxe extends ItemTool {
    ...
    public ItemAxe(ToolMaterial toolmaterial, float f, float f1, Item.Info item_info) {
        super(toolmaterial, TagsBlock.MINEABLE_WITH_AXE, f, f1, item_info);
    }
    ...
    private static boolean playerHasShieldUseIntent(ItemActionContext itemactioncontext) {
        ...
        return itemactioncontext.getHand().equals(EnumHand.MAIN_HAND) && entityhuman.getOffhandItem().is(Items.SHIELD) && !entityhuman.isSecondaryUseActive();
    }

...
public class BrushItem extends Item {
        ...
        if (i >= 0 && entityliving instanceof EntityHuman entityhuman) {
            ...
            if (movingobjectposition instanceof MovingObjectPositionBlock movingobjectpositionblock) {
                if (movingobjectposition.getType() == MovingObjectPosition.EnumMovingObjectType.BLOCK) {
                    int j = this.getUseDuration(itemstack, entityliving) - i + 1;
                    boolean flag = j % 10 == 5;
                    ...
                    if (flag) {
                        ...
                        if (world instanceof WorldServer) {
                            ...
                            if (tileentity instanceof BrushableBlockEntity) {
                                ...
                                boolean flag1 = brushableblockentity.brush(world.getGameTime(), worldserver, entityhuman, movingobjectpositionblock.getDirection(), itemstack);
                                ...
                                if (flag1) {
                                    ...
                                    itemstack.hurtAndBreak(1, entityhuman, enumitemslot);
                                }
                            }
                        }
                    }
    ...
    private MovingObjectPosition calculateHitResult(EntityHuman entityhuman) {
        return ProjectileHelper.getHitResultOnViewVector(entityhuman, IEntitySelector.CAN_BE_PICKED, entityhuman.blockInteractionRange());
    }

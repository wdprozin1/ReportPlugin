...
public final class CustomData {
    ...
    public MinecraftKey parseEntityId() {
        return !this.tag.contains("id", 8) ? null : MinecraftKey.tryParse(this.tag.getString("id"));
    }
    ...
    public <T> T parseEntityType(HolderLookup.a holderlookup_a, ResourceKey<? extends IRegistry<T>> resourcekey) {
        ...
        return minecraftkey == null ? null : holderlookup_a.lookup(resourcekey).flatMap((holderlookup_b) -> {

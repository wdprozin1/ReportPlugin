...
public interface EnchantmentEffectComponents {
    ...
    DataComponentType<List<ItemCrossbow.b>> CROSSBOW_CHARGING_SOUNDS = register("crossbow_charging_sounds", (datacomponenttype_a) -> {
        return datacomponenttype_a.persistent(ItemCrossbow.b.CODEC.listOf());
    });

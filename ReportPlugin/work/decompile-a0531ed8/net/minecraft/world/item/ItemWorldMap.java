                                    ...
                                    for (i3 = 0; i3 < i; ++i3) {
                                        for (int j3 = 0; j3 < i; ++j3) {
                                            ...
                                            if (k3 > world.getMinY()) {
                                                ...
                                                } while (iblockdata.getMapColor(world, blockposition_mutableblockposition) == MaterialMapColor.NONE && k3 > world.getMinY());

                                                if (k3 > world.getMinY() && !iblockdata.getFluidState().isEmpty()) {
                                                    int l3 = k3 - 1;
                                                    ...
                                                    do {
                                                        ...
                                                        ++l2;
                                                    } while (l3 > world.getMinY() && !iblockdata1.getFluidState().isEmpty());

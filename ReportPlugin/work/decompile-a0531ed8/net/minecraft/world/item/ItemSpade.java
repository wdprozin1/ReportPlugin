...
public class ItemSpade extends ItemTool {
    ...
    public ItemSpade(ToolMaterial toolmaterial, float f, float f1, Item.Info item_info) {
        super(toolmaterial, TagsBlock.MINEABLE_WITH_SHOVEL, f, f1, item_info);
    }
        ...
        if (itemactioncontext.getClickedFace() == EnumDirection.DOWN) {
            ...
            if (iblockdata2 != null) {
                if (!world.isClientSide) {
                    ...
                    world.gameEvent((Holder) GameEvent.BLOCK_CHANGE, blockposition, GameEvent.a.of(entityhuman, iblockdata2));
                    if (entityhuman != null) {

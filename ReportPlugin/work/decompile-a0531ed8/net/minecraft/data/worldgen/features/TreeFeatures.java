...
public class TreeFeatures {
    ...
    public static void bootstrap(BootstrapContext<WorldGenFeatureConfigured<?, ?>> bootstrapcontext) {
        ...
        FeatureUtils.register(bootstrapcontext, TreeFeatures.OAK_BEES_0002, WorldGenerator.TREE, createOak().decorators(List.of(worldgenfeaturetreebeehive)).build());
        ...
        FeatureUtils.register(bootstrapcontext, TreeFeatures.FANCY_OAK_BEES_0002, WorldGenerator.TREE, createFancyOak().decorators(List.of(worldgenfeaturetreebeehive)).build());

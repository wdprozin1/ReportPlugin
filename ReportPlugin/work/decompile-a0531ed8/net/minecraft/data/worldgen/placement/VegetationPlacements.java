...
public class VegetationPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> bootstrapcontext) {
        ...
        Holder<WorldGenFeatureConfigured<?, ?>> holder25 = holdergetter.getOrThrow(VegetationFeatures.FLOWER_PALE_GARDEN);
        Holder<WorldGenFeatureConfigured<?, ?>> holder26 = holdergetter.getOrThrow(VegetationFeatures.TREES_PLAINS);
        Holder<WorldGenFeatureConfigured<?, ?>> holder27 = holdergetter.getOrThrow(VegetationFeatures.DARK_FOREST_VEGETATION);
        Holder<WorldGenFeatureConfigured<?, ?>> holder28 = holdergetter.getOrThrow(VegetationFeatures.PALE_GARDEN_VEGETATION);
        Holder<WorldGenFeatureConfigured<?, ?>> holder29 = holdergetter.getOrThrow(VegetationFeatures.FOREST_FLOWERS);
        Holder<WorldGenFeatureConfigured<?, ?>> holder30 = holdergetter.getOrThrow(VegetationFeatures.PALE_FOREST_FLOWERS);
        Holder<WorldGenFeatureConfigured<?, ?>> holder31 = holdergetter.getOrThrow(VegetationFeatures.PALE_MOSS_PATCH);
        Holder<WorldGenFeatureConfigured<?, ?>> holder32 = holdergetter.getOrThrow(VegetationFeatures.TREES_FLOWER_FOREST);
        Holder<WorldGenFeatureConfigured<?, ?>> holder33 = holdergetter.getOrThrow(VegetationFeatures.MEADOW_TREES);
        Holder<WorldGenFeatureConfigured<?, ?>> holder34 = holdergetter.getOrThrow(VegetationFeatures.TREES_TAIGA);
        Holder<WorldGenFeatureConfigured<?, ?>> holder35 = holdergetter.getOrThrow(VegetationFeatures.TREES_GROVE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder36 = holdergetter.getOrThrow(TreeFeatures.OAK);
        Holder<WorldGenFeatureConfigured<?, ?>> holder37 = holdergetter.getOrThrow(TreeFeatures.SPRUCE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder38 = holdergetter.getOrThrow(TreeFeatures.CHERRY_BEES_005);
        Holder<WorldGenFeatureConfigured<?, ?>> holder39 = holdergetter.getOrThrow(TreeFeatures.SWAMP_OAK);
        Holder<WorldGenFeatureConfigured<?, ?>> holder40 = holdergetter.getOrThrow(VegetationFeatures.TREES_SAVANNA);
        Holder<WorldGenFeatureConfigured<?, ?>> holder41 = holdergetter.getOrThrow(VegetationFeatures.BIRCH_TALL);
        Holder<WorldGenFeatureConfigured<?, ?>> holder42 = holdergetter.getOrThrow(TreeFeatures.BIRCH_BEES_0002);
        Holder<WorldGenFeatureConfigured<?, ?>> holder43 = holdergetter.getOrThrow(VegetationFeatures.TREES_WINDSWEPT_HILLS);
        Holder<WorldGenFeatureConfigured<?, ?>> holder44 = holdergetter.getOrThrow(VegetationFeatures.TREES_WATER);
        Holder<WorldGenFeatureConfigured<?, ?>> holder45 = holdergetter.getOrThrow(VegetationFeatures.TREES_BIRCH_AND_OAK);
        Holder<WorldGenFeatureConfigured<?, ?>> holder46 = holdergetter.getOrThrow(VegetationFeatures.TREES_SPARSE_JUNGLE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder47 = holdergetter.getOrThrow(VegetationFeatures.TREES_OLD_GROWTH_SPRUCE_TAIGA);
        Holder<WorldGenFeatureConfigured<?, ?>> holder48 = holdergetter.getOrThrow(VegetationFeatures.TREES_OLD_GROWTH_PINE_TAIGA);
        Holder<WorldGenFeatureConfigured<?, ?>> holder49 = holdergetter.getOrThrow(VegetationFeatures.TREES_JUNGLE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder50 = holdergetter.getOrThrow(VegetationFeatures.BAMBOO_VEGETATION);
        Holder<WorldGenFeatureConfigured<?, ?>> holder51 = holdergetter.getOrThrow(VegetationFeatures.MUSHROOM_ISLAND_VEGETATION);
        Holder<WorldGenFeatureConfigured<?, ?>> holder52 = holdergetter.getOrThrow(VegetationFeatures.MANGROVE_VEGETATION);
        ...
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_GRASS_TAIGA_2, holder6, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_GRASS_TAIGA, holder6, worldSurfaceSquaredWithCount(7));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_GRASS_JUNGLE, holder7, worldSurfaceSquaredWithCount(25));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.GRASS_BONEMEAL, holder8, PlacementUtils.isEmpty());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_DEAD_BUSH_2, holder9, worldSurfaceSquaredWithCount(2));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_DEAD_BUSH, holder9, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_DEAD_BUSH_BADLANDS, holder9, worldSurfaceSquaredWithCount(20));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_MELON, holder10, RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_MELON_SPARSE, holder10, RarityFilter.onAverageOnceEvery(64), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_BERRY_COMMON, holder11, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_BERRY_RARE, holder11, RarityFilter.onAverageOnceEvery(384), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_WATERLILY, holder12, worldSurfaceSquaredWithCount(4));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_TALL_GRASS_2, holder13, NoiseThresholdCountPlacement.of(-0.8D, 0, 7), RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_TALL_GRASS, holder13, RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_LARGE_FERN, holder14, RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_CACTUS_DESERT, holder15, RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_CACTUS_DECORATED, holder15, RarityFilter.onAverageOnceEvery(13), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_SUGAR_CANE_SWAMP, holder16, RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_SUGAR_CANE_DESERT, holder16, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_SUGAR_CANE_BADLANDS, holder16, RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PATCH_SUGAR_CANE, holder16, RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.BROWN_MUSHROOM_NETHER, holder17, RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.RED_MUSHROOM_NETHER, holder18, RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.BROWN_MUSHROOM_NORMAL, holder17, getMushroomPlacement(256, (PlacementModifier) null));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.RED_MUSHROOM_NORMAL, holder18, getMushroomPlacement(512, (PlacementModifier) null));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.BROWN_MUSHROOM_TAIGA, holder17, getMushroomPlacement(4, (PlacementModifier) null));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.RED_MUSHROOM_TAIGA, holder18, getMushroomPlacement(256, (PlacementModifier) null));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.BROWN_MUSHROOM_OLD_GROWTH, holder17, getMushroomPlacement(4, CountPlacement.of(3)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.RED_MUSHROOM_OLD_GROWTH, holder18, getMushroomPlacement(171, (PlacementModifier) null));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.BROWN_MUSHROOM_SWAMP, holder17, getMushroomPlacement(0, CountPlacement.of(2)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.RED_MUSHROOM_SWAMP, holder18, getMushroomPlacement(64, (PlacementModifier) null));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.FLOWER_WARM, holder19, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.FLOWER_DEFAULT, holder19, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.FLOWER_FLOWER_FOREST, holder20, CountPlacement.of(3), RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.FLOWER_SWAMP, holder21, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.FLOWER_PLAINS, holder22, NoiseThresholdCountPlacement.of(-0.8D, 15, 4), RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.FLOWER_CHERRY, holder24, NoiseThresholdCountPlacement.of(-0.8D, 5, 10), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.FLOWER_MEADOW, holder23, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.FLOWER_PALE_GARDEN, holder25, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        SurfaceWaterDepthFilter surfacewaterdepthfilter = SurfaceWaterDepthFilter.forMaxDepth(0);

        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_PLAINS, holder26, PlacementUtils.countExtra(0, 0.05F, 1), InSquarePlacement.spread(), surfacewaterdepthfilter, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPosition.ZERO)), BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.DARK_FOREST_VEGETATION, holder27, CountPlacement.of(16), InSquarePlacement.spread(), surfacewaterdepthfilter, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PALE_GARDEN_VEGETATION, holder28, CountPlacement.of(16), InSquarePlacement.spread(), surfacewaterdepthfilter, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.FLOWER_FOREST_FLOWERS, holder29, RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-1, 3), 0, 3)), BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.FOREST_FLOWERS, holder29, RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-3, 1), 0, 1)), BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PALE_GARDEN_FLOWERS, holder30, RarityFilter.onAverageOnceEvery(8), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_NO_LEAVES, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.PALE_MOSS_PATCH, holder31, CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_NO_LEAVES, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_FLOWER_FOREST, holder32, treePlacement(PlacementUtils.countExtra(6, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_MEADOW, holder33, treePlacement(RarityFilter.onAverageOnceEvery(100)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_CHERRY, holder38, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.CHERRY_SAPLING));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_TAIGA, holder34, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_GROVE, holder35, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_BADLANDS, holder36, treePlacement(PlacementUtils.countExtra(5, 0.1F, 1), Blocks.OAK_SAPLING));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_SNOWY, holder37, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1), Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_SWAMP, holder39, PlacementUtils.countExtra(2, 0.1F, 1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(2), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPosition.ZERO)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_WINDSWEPT_SAVANNA, holder40, treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_SAVANNA, holder40, treePlacement(PlacementUtils.countExtra(1, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.BIRCH_TALL, holder41, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_BIRCH, holder42, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.BIRCH_SAPLING));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_WINDSWEPT_FOREST, holder43, treePlacement(PlacementUtils.countExtra(3, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_WINDSWEPT_HILLS, holder43, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_WATER, holder44, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_BIRCH_AND_OAK, holder45, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_SPARSE_JUNGLE, holder46, treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_OLD_GROWTH_SPRUCE_TAIGA, holder47, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_OLD_GROWTH_PINE_TAIGA, holder48, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_JUNGLE, holder49, treePlacement(PlacementUtils.countExtra(50, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.BAMBOO_VEGETATION, holder50, treePlacement(PlacementUtils.countExtra(30, 0.1F, 1)));
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.MUSHROOM_ISLAND_VEGETATION, holder51, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstrapcontext, VegetationPlacements.TREES_MANGROVE, holder52, CountPlacement.of(25), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(5), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.MANGROVE_PROPAGULE.defaultBlockState(), BlockPosition.ZERO)));
    }
}
